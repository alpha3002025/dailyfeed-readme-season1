...
요약하자면, 백엔드 애플리케이션 설계시 어떤 관점과 어떤 지식을 가지고 있을지에 초점을 맞춰주셨으면 합니다. 현재는 k8s 인프라 설치에 관련해서 terraform 과 atlantis 기반으로 eks 와 주요 인프라 설치, 앱 배포시 주요 속성이 노출되지 않게하는 방법에 대한 문서화를 진행 중인데, eks 관련 실습 프로젝트와 가이드문서를 조만간 공개할 예정입니다.<br/>
<br/>
