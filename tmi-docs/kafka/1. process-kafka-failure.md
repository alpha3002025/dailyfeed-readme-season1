...
![](./img/1-process-kafka-failure/publisher-failure.png)
<br/>
...
![](./img/1-process-kafka-failure/listener-failure.png)
...
![](./img/1-process-kafka-failure/listener-publisher-failure.png)