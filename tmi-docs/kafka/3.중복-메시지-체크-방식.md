...
<br/>
**메신저**<br/>
메신저의 경우 사용자의 너무 잦은 요청은 Gateway 등을 통해 429 Response 를 하거나, 메시지 publisher 측에서도 나노세컨드 이하로의 정밀한 요청은 악의적인 요청으로 간주해 429 Response 등을 내려 보내서 다시 요청하도록 우회하는 것이 좋을 것이라고 생각합니다.<br/>
<br/>
