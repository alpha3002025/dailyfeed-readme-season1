...
[카프카 통신 실패 시 처리 대책](0.introduce-problem.md) 에서는`dailyfeed-content-svc` 에서 `dailyfeed-activity-svc` 에서 멤버 활동을 기록할 때 kafka 를 어떻게 사용하는지 살펴봤습니다. 
![](./img/introduce.png)

<br/>

[카프카 통신 실패 시 처리 대책](0.introduce-problem.md) 에서 정리했었지만, 통신 절차를 요약해보면 다음과 같습니다.<br/>
<br/>
