...
![](./img/0-docker-image-build/github-actions-menu.png)
<br/>
...
![](./img/0-docker-image-build/ghcr1.png)
<br/>


docker 이미지 페이지로 이동하면 다음과 같이 방금 전에 빌드된 이미지를 확인하실 수 있습니다.<br/>
![](./img/0-docker-image-build/ghcr2.png)
...
![](./img/0-docker-image-build/github-secrets-and-variables.png)
<br/>
<br/>
